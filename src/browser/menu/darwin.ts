    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          label: 'New Tab',
          accelerator: 'Cmd+T',
          click: (item, win) => sendMessage(win as BrowserWindow, event.BROWSER_MENU_QUERY_TAB_NEW),
        },
        {
          label: 'Close Tab',
          accelerator: 'Cmd+W',
          click: (item, win) =>
            sendMessage(win as BrowserWindow, event.BROWSER_MENU_QUERY_TAB_CLOSE),
        },
        {
          type: 'separator',
        },
        {
          label: 'Save Query',
          accelerator: 'Cmd+S',
          click: (item, win) => sendMessage(win as BrowserWindow, event.BROWSER_MENU_QUERY_SAVE),
        },
        {
          label: 'Save Query As',
          accelerator: 'Shift+Cmd+S',
          click: (item, win) => sendMessage(win as BrowserWindow, event.BROWSER_MENU_QUERY_SAVE_AS),
        },
        {
          label: 'Open Query',
          accelerator: 'Cmd+O',
          click: (item, win) => sendMessage(win as BrowserWindow, event.BROWSER_MENU_QUERY_OPEN),
        },
      ],
    },
    {
      ...
      submenu: [
        ...
        },
        {
          label: 'Execute',
          accelerator: 'Cmd+R',
          click: (item, win) => sendMessage(win as BrowserWindow, event.BROWSER_MENU_QUERY_EXECUTE),
        },
        {
          label: 'Focus Query Editor',
          accelerator: 'Shift+Cmd+0',
          click: (item, win) => sendMessage(win as BrowserWindow, event.BROWSER_MENU_QUERY_FOCUS),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          label: 'Zoom In',
          accelerator: 'Cmd+=',
          click: (item, win) => sendMessage(win as BrowserWindow, event.BROWSER_MENU_ZOOM_IN),
        },
        {
          label: 'Zoom Out',
          accelerator: 'Cmd+-',
          click: (item, win) => sendMessage(win as BrowserWindow, event.BROWSER_MENU_ZOOM_OUT),
        },
        {
          label: 'Reset Zoom',
          accelerator: 'Cmd+0',
          click: (item, win) => sendMessage(win as BrowserWindow, event.BROWSER_MENU_ZOOM_RESET),
        },
      ],
    },
    {
      ...
      submenu: [
        {
          ...
          click: (item, win) =>
            sendMessage(win as BrowserWindow, event.BROWSER_MENU_TOGGLE_DB_SEARCH),
        },
        {
          label: 'Search database objects',
          accelerator: 'Cmd+9',
          click: (item, win) =>
            sendMessage(win as BrowserWindow, event.BROWSER_MENU_TOGGLE_DB_OBJS_SEARCH),
        },
      ],
    },
    {
